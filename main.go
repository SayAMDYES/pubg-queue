...
func main() {
	...
	*adminPass = ""
	...
	r.Route("/admin", func(r chi.Router) {
		...
		r.With(authMW.RequireAdmin).Post("/events/{date}/delete", adminH.DeleteEvent)
		...
		r.With(authMW.RequireAdmin).Post("/users/{id}/delete", adminH.DeleteUser)
		r.With(authMW.RequireAdmin).Post("/users/{id}/reset-password", adminH.ResetUserPassword)
	})
